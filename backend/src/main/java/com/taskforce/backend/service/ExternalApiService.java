...
public class ExternalApiService {
    ...
    public List<Train> fetchTrains(String origin, String destination) {
        ...
        try {
            String url = "https://" + RAPIDAPI_HOST_TRAINS + "/api/v1/searchTrain?fromStationCode=" + (origin != null ? origin.toUpperCase() : "NDLS") + "&toStationCode=" + (destination != null ? destination.toUpperCase() : "BCT");
    ...
    public List<Bus> fetchBuses(String origin, String destination) {
        ...
        try {
            String url = "https://" + RAPIDAPI_HOST_BUSES + "/api/v1/getBusDetails?from=" + origin + "&to=" + destination;
    ...
    public List<Flight> fetchFlights(String origin, String destination) {
        ...
        try {
            String url = "https://" + RAPIDAPI_HOST_FLIGHTS + "/api/v1/flights/searchFlights?originSkyId=" + origin + "&destinationSkyId=" + destination;
    ...
    public List<Hotel> fetchHotels(String location) {
        ...
        try {
            String url = "https://" + RAPIDAPI_HOST_HOTELS + "/v1/hotels/search?dest_id=-2095660&locale=en-gb&checkin_date=2024-05-19&dest_type=city&checkout_date=2024-05-20";
