    ...
    <div className="home-page pb-5">
      ...
      <Container fluid className="p-0 mb-5">
        <div className="carousel-container px-md-5">
          <Carousel indicators={true} interval={4000} pause="hover" className="rounded-5 shadow-lg overflow-hidden">
            <Carousel.Item>
              <img className="d-block w-100 rounded-5" src={image1} alt="Explore the world" />
            ...
            <Carousel.Item>
              <img className="d-block w-100 rounded-5" src={image2} alt="Luxury Stays" />
              <Carousel.Caption className="bg-glass rounded-4 p-4 text-dark mb-4 mx-4">
            ...
            <Carousel.Item>
              <img className="d-block w-100 rounded-5" src={image3} alt="Seamless Travel" />
              <Carousel.Caption className="bg-glass rounded-4 p-4 text-dark mb-4 mx-4">
